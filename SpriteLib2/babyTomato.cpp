...
babyTomato::babyTomato(string n, float ms, float pX, float pY, int fSX, int fSY, float cd, float ft, int hp, int rng, int dmg, bool R)
	:Enemy::Enemy(n, ms, pX, pY, fSX, fSY, cd, ft, hp, rng, dmg, R)
{

}

babyTomato::~babyTomato()
{
}

void babyTomato::behave(Player &p1, vector<Enemy*> &enemies, vector<Sprite*>& enemySprite, vector<Projectile_E*> &pro, vector<Sprite*>& proSprite)
{
